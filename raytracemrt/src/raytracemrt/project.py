...
def project(therm_scan_path, pts_path, sensor_pos, res_path, vx_path, v_size, viz):
    ...
    viz_dlist = []
    plydata = PlyData.read(pts_path)
    vertices = plydata['vertex'].data.tolist()
    xyzs_ls = np.array(vertices)
    vxres_dict = geomie3d.modify.xyzs2voxs(xyzs_ls, v_size, v_size, v_size)
    ...
    print('creating bboxes1')
    for ijk in ijks:
        vx = vxs[ijk]
        midpt = vx['midpt']
        att = {'idx': vx['idx'], 'ijk': ijk, 'midpt':midpt}
        midpts.append(midpt)
        atts.append(att)
    print('creating bboxes2')
    bbx_ls = geomie3d.create.bboxes_frm_midpts(midpts, xdims, ydims, zdims, atts)
    print(len(bbx_ls))
...
if __name__ == '__main__':
    therm_scan_path = '/home/chenkianwee/kianwee_work/get/projects/r2/data/ETH CHAOSense data analysis/Example_ProcessingOutput/SoLo_Therm_08-08-2025_13-51-50_LWpointCloud.ply'
    pts_path = '/home/chenkianwee/kianwee_work/get/projects/r2/data/ETH CHAOSense data analysis/Lidar/lidar_csv_LIDARpointCloud.ply'
    sensor_pos = [0,0,0]#[1,0,1]
    res_path = '/home/chenkianwee/kianwee_work/get/projects/r2/data/ETH CHAOSense data analysis/res/intersections.ply'
    vx_path = '/home/chenkianwee/kianwee_work/get/projects/r2/data/ETH CHAOSense data analysis/resprojected_voxels0.json'
    v_size = 100
    viz = True
